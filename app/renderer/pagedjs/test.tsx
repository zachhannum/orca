const Test = () => {
  return (
    <template id="flow">
      <section className="body-rw Chapter-rw">
        <header>
          <h1>
            <span className="audio" id="c001s0000">
              Chapter 1. Loomings.
            </span>
          </h1>
        </header>
        ...
        <p>
          <span className="audio" id="c001s0001">
            Call me Ishmael.
          </span>{' '}
          <span className="audio" id="c001s0002">
          ...
          <span className="audio" id="c001s0003">
            It is a way I have of driving off the spleen and regulating the
            circulation.
          </span>{' '}
          <span className="audio" id="c001s0004">
            Whenever I find myself growing grim about the mouth;{' '}
            <a href="#fred">go to Fred</a> whenever it is a damp, drizzly
          ...
          <span className="audio" id="c001s0005">
            This is my substitute for pistol and ball.
          </span>{' '}
          <span className="audio" id="c001s0006">
            With a philosophical flourish Cato throws himself upon his sword; I
            quietly take to the ship.
          </span>{' '}
          <span className="audio" id="c001s0007">
            There is nothing surprising in this.
          </span>{' '}
          <span className="audio" id="c001s0008">
        ...
        <p>
          <span className="audio" id="c001p0002">
        ...
        <p>
          <span className="audio" id="c001p0003">
        ...
        <p>
          <span className="audio" id="c001p0004">
        ...
        <p>
          <span className="audio" id="c001p0005">
        ...
        <p>
          <span className="audio" id="c001p0006">
            ...
            spurs of mountains bathed in their hill-side blue. But though the
            picture lies thus tranced, and though this pine-tree shakes down its
            sighs like leaves upon this shepherd’s head, yet all were vain,
            ...
            wanting?—Water—there is not a drop of water there! Were Niagara but
            a cataract of sand, would you travel your thousand miles to see it?
            Why did the poor poet of Tennessee, upon suddenly receiving two
        ...
        <p>
          <span className="audio" id="c001p0007">
        ...
        <p>
          <span className="audio" id="c001p0008">
            ...
            honour, particularly if you come of an old established family in the
            ...
            you have been lording it as a country schoolmaster, making the
            tallest boys stand in awe of you. The transition is a keen one, I
        ...
        <p>
          <span className="audio" id="c001p0009">
            ...
            so the universal thump is passed round, and all hands should rub
            each other’s shoulder-blades, and be content.
          </span>
        </p>
        <p>
          <span className="audio" id="c001p0010">
        ...
        <p>
          <span className="audio" id="c001p0011">
            ...
            leaders in many other things, at the same time that the leaders
            little suspect it. But wherefore it was that after having repeatedly
            smelt the sea as a merchant sailor, I should now take it into my
            head to go on a whaling voyage; this the invisible police officer of
            the Fates, who has the constant surveillance of me, and secretly
            dogs me, and influences me in some unaccountable way—he can better
            ...
            and solo between more extensive performances. I take it that this
            part of the bill must have run something like this:
          </span>
        </p>

        <div className="block-rw extract-rw headline-rw">
          <p>
            <span className="audio" id="c001p0012">
              “GRAND CONTESTED ELECTION FOR THE PRESIDENCY OF THE UNITED STATES.
            </span>
          </p>
          <p>
            <span id="fred" className="audio">
              “WHALING VOYAGE BY ONE ISHMAEL.
            </span>
          </p>
          <p>
            <span className="audio" id="c001p0014">
              “BLOODY BATTLE IN AFFGHANISTAN.”
            </span>
          </p>
        </div>
        <p>
          <span className="audio" id="c001p0015">
            ...
            various disguises, induced me to set about performing the part I
            did, besides cajoling me into the delusion that it was a choice
            resulting from my own unbiased freewill and discriminating judgment.
          </span>
        </p>
        <p>
          <span className="audio" id="c001p0016">
        ...
        <p>
          <span className="audio" id="c001p0017">
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>
            <span className="audio" id="c002p0000">
              Chapter 2. The Carpet-Bag.
            </span>
          </h1>
        </header>
        <p>
          <span className="audio" id="c002p0001">
        ...
        <p>
          <span className="audio" id="c002p0002">
            ...
            whalemen, the Red-Men, first sally out in canoes to give chase to
            the Leviathan? And where but from Nantucket, too, did that first
        ...
        <p>
          <span className="audio" id="c002p0003">
        ...
        <p>
          <span className="audio" id="c002p0004">
        ...
        <p>
          <span className="audio" id="c002p0005">
            ...
            a smoky light proceeding from a low, wide building, the door of
        ...
        <p>
          <span className="audio" id="c002p0006">
        ...
        <p>
          <span className="audio" id="c002p0007">
        ...
        <p>
          <span className="audio" id="c002p0008">
            ...
            the dilapidated little wooden house itself looked as if it might
            have been carted here from the ruins of some burnt district, and as
            the swinging sign had a poverty-stricken sort of creak to it, I
            thought that here was the very spot for cheap lodgings, and the best
            of pea coffee.
          </span>
        </p>
        <p>
          <span className="audio" id="c002p0009">
        ...
        <p>
          <span className="audio" id="c002p0010">
        ...
        <p>
          <span className="audio" id="c002p0011">
        ...
        <p>
          <span className="audio" id="c002p0012">
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 3. The Spouter-Inn.</h1>
        </header>
        <p>
          Entering that gable-ended Spouter-Inn, you found yourself in a wide,
          low, straggling entry with old-fashioned wainscots, reminding one of
          the bulwarks of some condemned old craft. On one side hung a very
          large oilpainting so thoroughly besmoked, and every way defaced, that
        ...
        <p>
          ...
          the breaking-up of the icebound stream of Time. But at last all these
          fancies yielded to that one portentous something in the picture’s
          midst. THAT once found out, and all the rest were plain. But stop;
        ...
        <p>
          ...
          whaling lances and harpoons all broken and deformed. Some were storied
          weapons. With this once long lance, now wildly elbowed, fifty years
          ago did Nathan Swain kill fifteen whales between a sunrise and a
          ...
          Cape of Blanco. The original iron entered nigh the tail, and, like a
        ...
        <p>
          ...
          coach might almost drive beneath it. Within are shabby shelves, ranged
        ...
        <p>
          ...
          have ye? I s’pose you are goin’ a-whalin’, so you’d better get used to
          that sort of thing.”
        </p>
        <p>
        ...
        <p>
          ...
          and potatoes, but dumplings; good heavens! dumplings for supper! One
        ...
        <p>
          ...
          this morning; a three years’ voyage, and a full ship. Hurrah, boys;
        ...
        <p>
          ...
          over. Besides, it was getting late, and my decent harpooneer ought to
          be home and going bedwards. Suppose now, he should tumble in upon me
        ...
        <p>
          ...
          he procured the plane; and with his old silk handkerchief first
          ...
          was near spraining his wrist, and I told him for heaven’s sake to
          quit—the bed was soft enough to suit me, and I did not know how all
        ...
        <p>
          ...
          harpooneer is, and whether I shall be in all respects safe to spend
          the night with him. And in the first place, you will be so good as to
          unsay that story about selling his head, which if true I take to be
          good evidence that this harpooneer is stark mad, and I’ve no idea of
          sleeping with a madman; and you, sir, YOU I mean, landlord, YOU, sir,
          by trying to induce me to do so knowingly, would thereby render
        ...
        <p>
          ...
          at the same time what could I think of a harpooneer who stayed out of
          a Saturday night clean into the holy Sabbath, engaged in such a
        ...
        <p>
          ...
          and somehow, Sam got pitched on the floor, and came near breaking his
        ...
        <p>
          ...
          face! It was of a dark, purplish, yellow colour, here and there stuck
          ...
          remembered a story of a white man—a whaleman too—who, falling among
          the cannibals, had been tattooed by them. I concluded that this
          ...
          outside; a man can be honest in any sort of skin. But then, what to
          make of his unearthly complexion, that part of it, I mean, lying round
          about, and completely independent of the squares of tattooing. To be
          sure, it might be nothing but a good coat of tropical tanning; but I
          never heard of a hot sun’s tanning a white man into a purplish yellow
          one. However, I had never been in the South Seas; and perhaps the sun
        ...
        <p>
          ...
          quaked to think of it. A peddler of heads too—perhaps the heads of his
          own brothers. He might take a fancy to mine—heavens! look at that
          tomahawk!
        </p>
        <p>
        ...
        <p>
          ...
          seem to fancy such dry sort of fare at all; he never moved his lips.
          All these strange antics were accompanied by still stranger guttural
          noises from the devotee, who seemed to be praying in a sing-song or
          else singing some pagan psalmody or other, during which his face
          twitched about in the most unnatural manner. At last extinguishing the
          fire, he took the idol up very unceremoniously, and bagged it again in
          his grego pocket as carelessly as if he were a sportsman bagging a
          dead woodcock.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 4. The Counterpane.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          third floor, undressed myself as slowly as possible so as to kill
        ...
        <p>
          ...
          most conscientious of stepmothers, and back I had to go to my room.
          For several hours I lay there broad awake, feeling a great deal worse
          than I have ever done since, even from the greatest subsequent
          misfortunes. At last I must have fallen into a troubled nightmare of a
          doze; and slowly waking from it—half steeped in dreams—I opened my
          eyes, and the before sun-lit room was now wrapped in outer darkness.
          Instantly I felt a shock running through all my frame; nothing was to
          be seen, and nothing was to be heard; but a supernatural hand seemed
        ...
        <p>
          ...
          hugging a fellow male in that matrimonial sort of style, I succeeded
          in extracting a grunt; and presently, he drew back his arm, shook
          himself all over like a Newfoundland dog just from the water, and sat
          up in bed, stiff as a pike-staff, looking at me, and rubbing his eyes
          as if he did not altogether remember how I came to be there, though a
          dim consciousness of knowing something about me seemed slowly dawning
        ...
        <p>
          ...
          education was not yet completed. He was an undergraduate. If he had
          not been a small degree civilized, he very probably would not have
          troubled himself with boots at all; but then, if he had not been still
          a savage, he never would have dreamt of getting under the bed to put
          them on. At last, he emerged with his hat very much dented and crushed
          down over his eyes, and began creaking and limping about the room, as
          if, not being much accustomed to boots, his pair of damp, wrinkled
          cowhide ones—probably not made to order either—rather pinched and
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          the slightest bashfulness had boarded great whales on the high
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          but a few hours old. Look there! that chap strutting round the corner.
          He wears a beaver hat and swallow-tailed coat, girdled with a
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          the first time behold Father Mapple without the utmost interest,
          because there were certain engrafted clerical peculiarities about him,
          imputable to that adventurous maritime life he had led. When he
          entered I observed that he carried no umbrella, and certainly had not
          come in his carriage, for his tarpaulin hat ran down with melting
          sleet, and his great pilot cloth jacket seemed almost to drag him to
          the floor with the weight of the water it had absorbed. However, hat
          and coat and overshoes were one by one removed, and hung up in a
          little space in an adjacent corner; when, arrayed in a decent suit, he
      ...
      <section className="body-rw Chapter-rw">
        ...
        <div className="block-rw extract-verse-rw">
          ...
          believe him mine, He bowed his ear to my complaints— No more the whale
          did me confine. “With speed he flew to my relief, As on a radiant
          dolphin borne; Awful, yet bright, as lightning shone The face of my
          Deliverer God. “My song for ever shall record That terrible, that
        ...
        <p>
          ...
          of the smallest strands in the mighty cable of the Scriptures. Yet
          what depths of the soul does Jonah’s deep sealine sound! what a
          ...
          bottom of the waters; sea-weed and all the slime of the sea is about
          us! But WHAT is this lesson that the book of Jonah teaches? Shipmates,
          it is a two-stranded lesson; a lesson to us all as sinful men, and a
          ...
          was, or how conveyed—which he found a hard command. But all the things
          that God would have us do are hard for us to do—remember that—and
          hence, he oftener commands us than endeavors to persuade. And if we
          obey God, we must disobey ourselves; and it is in this disobeying
        ...
        <p>
          ...
          dodging search, he finds the Tarshish ship receiving the last items of
          her cargo; and as he steps on board to see its Captain in the cabin,
          all the sailors for the moment desist from hoisting in the goods, to
          mark the stranger’s evil eye. Jonah sees this; but in vain he tries to
          ...
          other—"Jack, he’s robbed a widow;" or, “Joe, do you mark him; he’s a
          bigamist;" or, “Harry lad, I guess he’s the adulterer that broke jail
          in old Gomorrah, or belike, one of the missing murderers from Sodom.”
          Another runs to read the bill that’s stuck against the spile upon the
          wharf to which the ship is moored, offering five hundred gold coins
          for the apprehension of a parricide, and containing a description of
        ...
        <p>
          ...
          deserts,—when wretched Jonah cries out to them to take him and cast
          him forth into the sea, for he knew that for HIS sake this great
        ...
        <p>
          ...
          and inward delight—who against the proud gods and commodores of this
          earth, ever stands forth his own inexorable self. Delight is to him
          ...
          lord, but the Lord his God, and is only a patriot to heaven. Delight
          is to him, whom all the waves of the billows of the seas of the
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 10. A Bosom Friend.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          would then begin again at the next fifty; seeming to commence at
        ...
        <p>
          ...
          cannot hide the soul. Through all his unearthly tattooings, I thought
          I saw the traces of a simple honest heart; and in his large, deep
          eyes, fiery black and bold, there seemed tokens of a spirit that would
          dare a thousand devils. And besides all this, there was a certain
          ...
          one. It may seem ridiculous, but it reminded me of General
          Washington’s head, as seen in the popular busts of him. It had the
          same long regularly graded retreating slope from above the brows,
          which were likewise very projecting, like two long promontories
        ...
        <p>
          ...
          there was something almost sublime in it. Here was a man some twenty
          thousand miles from home, by the way of Cape Horn, that is—which was
          the only way he could get there—thrown among people as strange to him
          as though he were in the planet Jupiter; and yet he seemed entirely at
          ...
          fine philosophy; though no doubt he had never heard there was such a
          thing as that. But, perhaps, to be true philosophers, we mortals
          should not be conscious of so living or so striving. So soon as I hear
          that such or such a man gives himself out for a philosopher, I
        ...
        <p>
          ...
          do the will of God—THAT is worship. And what is the will of God?—to do
          ...
          Queequeg; salamed before him twice or thrice; kissed his nose; and
          that done, we undressed and went to bed, at peace with our own
          consciences and all the world. But we did not go to sleep without some
          little chat.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          that is not what it is merely by contrast. Nothing exists in itself.
          If you flatter yourself that you are all over comfortable, and have
          been so a long time, then you cannot be said to be comfortable any
          ...
          general consciousness you feel most delightfully and unmistakably
          ...
          For the height of this sort of deliciousness is to have nothing but
          the blanket between you and your snugness and the cold of the outer
          air. Then there you lie like the one warm spark in the heart of an
          arctic crystal.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          savage—this sea Prince of Wales, never saw the Captain’s cabin. They
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          his heavy chest to his boarding house. Not to seem ignorant about the
          thing—though in truth he was entirely so, concerning the precise way
          in which to manage the barrow—Queequeg puts his chest upon it; lashes
          it fast; and then shoulders the barrow and marches up the wharf.
          “Why,” said I, “Queequeg, you might have known better than that, one
        ...
        <p>
          ...
          the immemorial ceremony of the island; that is, dipping his
        ...
        <p>
          “Hallo, <i>you</i> sir,” cried the Captain, a gaunt rib of the sea,
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          having but a right of way through it. Merchant ships are but extension
          bridges; armed ones but floating forts; even pirates and privateers,
          though following the sea as highwaymen the road, they but plunder
          other ships, other fragments of the land like themselves, without
          seeking to draw their living from the bottomless deep itself. The
          Nantucketer, he alone resides and riots on the sea; he alone, in Bible
          language, goes down to it in ships; to and fro ploughing it as his own
          special plantation. THERE is his home; THERE lies his business, which
          a Noah’s flood would not interrupt, though it overwhelmed all the
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          outset, Queequeg insisted that the yellow warehouse—our first point of
          departure—must be left on the larboard hand, whereas I had understood
          Peter Coffin to say it was on the starboard. However, by dint of
          beating about a little in the dark, and now and then knocking up a
        ...
        <p>
          ...
          TWO of them, one for Queequeg, and one for me. It’s ominous, thinks I.
          A Coffin my Innkeeper upon landing in my first whaling port;
        ...
        <p>
          ...
          his harpoon; she allowed no harpoon in her chambers. “Why not?” said
          I; “every true whaleman sleeps with his harpoon—but why not?” “Because
          ...
          only three barrels of <i>ile</i>, was found dead in my first floor
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          her old antiquities, were added new and marvellous features,
          pertaining to the wild business that for more than half a century she
          had followed. Old Captain Peleg, many years her chief-mate, before he
          ...
          wheel at her reverend helm, she sported there a tiller; and that
          tiller was in one mass, curiously carved from the long narrow lower
          jaw of her hereditary foe. The helmsman who steered by that tiller in
          a tempest, felt like the Tartar, when he holds back his fiery steed by
          clutching its jaw. A noble craft, but somehow a most melancholy! All
        ...
        <p>
          ...
          the Pequod was as good a ship as any—I thought the best—and all this I
          now repeated to Peleg. Seeing me so determined, he expressed his
        ...
        <p>
          ...
          regarded, if either by birth or other circumstances, he have what
          seems a half wilful overruling morbidness at the bottom of his nature.
        ...
        <p>
          ...
          born Quaker one single jot, had not so much as altered one angle of
          his vest. Still, for all this immutableness, was there some lack of
        ...
        <p>
          ...
          clutch something—a hammer or a marling-spike, and go to work like mad,
        ...
        <p>
          ...
          the 275th lay—that is, the 275th part of the clear net proceeds of the
          voyage, whatever that might eventually amount to. And though the 275th
          lay was what they call a rather LONG LAY, yet it was better than
        ...
        <p>
          ...
          that never take on about princely fortunes, and am quite content if
          the world is ready to board and lodge me, while I am putting up at
        ...
        <p>
          ...
          jack-knife here needs the grindstone. That’s he; thank ye, Bildad. Now
          then, my young man, Ishmael’s thy name, didn’t ye say? Well then, down
          ye go here, Ishmael, for the three hundredth lay.”
        </p>
        <p>
        ...
        <p>
          ...
          foes than whales. His lance! aye, the keenest and the surest that out
          of all our isle! Oh! he ain’t Captain Bildad; no, and he ain’t Captain
        ...
        <p>
          ...
          warn thee. It’s a lie. I know Captain Ahab well; I’ve sailed with him
          as mate years ago; I know what he is—a good man—not a pious, good man,
          ...
          utter, hopeless harm in Ahab? No, no, my lad; stricken, blasted, if he
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          had taken from him, before our mounting to the chamber. That’s
        ...
        <p>
          ...
          counterpane—God pity his poor mother!—it will be the ruin of my house.
          Has the poor lad a sister? Where’s that girl?—there, Betty, go to
          Snarles the Painter, and tell him to paint me a sign, with—“no
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          of; and how to save all hands—how to rig jury-masts—how to get into
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          with Captain Ahab. But nothing about that thing that happened to him
          off Cape Horn, long ago, when he lay like dead for three days and
          ...
          have heard of that, I dare say. Oh yes, THAT every one knows a’most—I
          mean they know he’s only one leg; and that a parmacetti took the other
          off.”
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          spars, and spare lines and harpoons, and spare everythings, almost,
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          tattered pea-jacket. He was thrown at whole length upon two chests,
          his face downwards and inclosed in his folded arms. The profoundest
        ...
        <p>
          ...
          are heavy, it’s grinding the face of the poor. Get off, Queequeg!
          Look, he’ll twitch you off soon. I wonder he don’t wake.”
        </p>
        <p>
          ...
          settee of himself under a spreading tree, perhaps in some damp marshy
          place.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 22. Merry Christmas.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          made a pilot in order to save the Nantucket pilot-fee to all the ships
          ...
          told them that no profane songs would be allowed on board the Pequod,
        ...
        <p>
          ...
          the perils we both ran, in starting on the voyage with such a devil
          for a pilot. I was comforting myself, however, with the thought that
          in pious Bildad might be found some salvation, spite of his seven
          hundred and seventy-seventh lay; when I felt a sudden sharp poke in my
          rear, and turning round, was horrified at the apparition of Captain
        ...
        <p>
          ...
          encounter all the terrors of the pitiless jaw; loath to say good-bye
          to a thing so every way brimful of every interest to him,—poor old
          Bildad lingered long; paced the deck with anxious strides; ran down
          ...
          its pin, convulsively grasped stout Peleg by the hand, and holding up
          a lantern, for a moment stood gazing heroically in his face, as much
        ...
        <p>
          ...
          Have an eye to the molasses tierce, Mr. Stubb; it was a little leaky,
          I thought. If ye touch at the islands, Mr. Flask, beware of
          fornication. Good-bye, good-bye! Don’t keep that cheese too long down
          in the hold, Mr. Starbuck; it’ll spoil. Be careful with the
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 23. The Lee Shore.</h1>
        </header>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          we are surrounded by all manner of defilements. Butchers we are, that
          is true. But butchers, also, and butchers of the bloodiest badge have
          been all Martial Commanders whom the world invariably delights to
          honour. And as for the matter of the alleged uncleanliness of our
          business, ye shall soon be initiated into certain facts hitherto
          pretty generally unknown, and which, upon the whole, will triumphantly
          plant the sperm whale-ship at least among the cleanliest things of
          this tidy earth. But even granting the charge in question to be true;
          what disordered slippery decks of a whale-ship are comparable to the
        ...
        <p>
          ...
          Britain between the years 1750 and 1788 pay to her whalemen in
          bounties upwards of &#163;1,000,000? And lastly, how comes it that we
        ...
        <p>But this is not the half; look again.</p>
        <p>
          ...
          and archipelagoes which had no chart, where no Cook or Vancouver had
          ever sailed. If American and European men-of-war now peacefully ride
          in once savage harbors, let them fire salutes to the honour and glory
          of the whale-ship, which originally showed them the way, and first
          interpreted between them and the savages. They may celebrate as they
          will the heroes of Exploring Expeditions, your Cooks, your
          Krusensterns; but I say that scores of anonymous Captains have sailed
          out of Nantucket, that were as great, and greater than your Cook and
          your Krusenstern. For in their succourless empty-handedness, they, in
          the heathenish sharked waters, and by the beaches of unrecorded,
          javelin islands, battled with virgin wonders and terrors that Cook
          with all his marines and muskets would not willingly have dared. All
          that is made such a flourish of in the old South Sea Voyages, those
          things were but the life-time commonplaces of our heroic Nantucketers.
          Often, adventures which Vancouver dedicates three chapters to, these
          men accounted unworthy of being set down in the ship’s common log. Ah,
        ...
        <p>
          ...
          of the Spanish crown, touching those colonies; and, if space
        ...
        <p>
          ...
          Japan, is ever to become hospitable, it is the whale-ship alone to
        ...
        <p>
          ...
          shiver fifty lances with you there, and unhorse you with a split
          helmet every time.
        </p>
        <p>
        ...
        <p>*See subsequent chapters for something more on this head.</p>
        <p>
        ...
        <p>
          ...
          fifty whales. I account that man more honourable than that great
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 26. Knights and Squires.</h1>
        </header>
        <p>
          The chief mate of the Pequod was Starbuck, a native of Nantucket, and
          a Quaker by descent. He was a long, earnest man, and though born on an
          icy coast, seemed well adapted to endure hot latitudes, his flesh
          ...
          which his state is famous. Only some thirty arid summers had he seen;
          those summers had dried up all his physical superfluousness. But this,
          his thinness, so to speak, seemed no more the token of wasting
          ...
          ill-looking; quite the contrary. His pure tight skin was an excellent
          ...
          Polar snow or torrid sun, like a patent chronometer, his interior
          vitality was warranted to do well in all climates. Looking into his
          eyes, you seemed to see there the yet lingering images of those
          ...
          action, and not a tame chapter of sounds. Yet, for all his hardy
          sobriety and fortitude, there were certain qualities in him which at
          times affected, and in some cases seemed well nigh to overbalance all
          the rest. Uncommonly conscientious for a seaman, and endued with a
        ...
        <p>
          ...
          extreme. But it was not in reasonable nature that a man so organized,
          and with such terrible experiences and remembrances as he had; it was
          not in nature that these things should fail in latently engendering an
          element in him, which, under suitable circumstances, would break out
          from its confinement, and burn all his courage up. And brave as he
          might be, it was that sort of bravery chiefly, visible in some
          intrepid men, which, while generally abiding firm in the conflict with
          seas, or winds, or whales, or any of the ordinary irrational horrors
          of the world, yet cannot withstand those more terrific, because more
          spiritual terrors, which sometimes menace you from the concentrating
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 27. Knights and Squires.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          of honour with him, to destroy them whenever encountered. So utterly
          ...
          side timbers inserted into it, serves to brace the ship against the
        ...
        <p>
          ...
          Knight of old, is always accompanied by his boat-steerer or
        ...
        <p>
          ...
          them. In his youth Daggoo had voluntarily shipped on board of a
          whaler, lying in a lonely bay on his native coast. And never having
          been anywhere in the world but in Africa, Nantucket, and the pagan
          harbors most frequented by whalemen; and having now led for many years
          the bold life of the fishery in the ships of owners uncommonly heedful
          of what manner of men they shipped; Daggoo retained all his barbaric
          ...
          like a chess-man beside him. As for the residue of the Pequod’s
          ...
          are. Herein it is the same with the American whale fishery as with the
          ...
          ever come back. Black Little Pip—he never did—oh, no! he went before.
          Poor Alabama boy! On the grim Pequod’s forecastle, ye shall ere long
          see him, beating his tambourine; prelusive of the eternal time, when
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          more likely sea-officers and men, each in his own different way, could
          not readily be found, and they were every one of them Americans; a
          ...
          weather, though all the time running away from it to the southward;
          and by every degree and minute of latitude which we sailed, gradually
          leaving that merciless winter, and all its intolerable weather behind
          us. It was one of those less lowering, but still grey and gloomy
        ...
        <p>
          ...
          might hardly come to pass, so he muttered—then, whoever should do that
          last office for the dead, would find a birth-mark on him from crown to
          sole.
        </p>
        <p>
          ...
          the old Gay-Head Indian once; “but like his dismasted craft, he
          shipped another mast without coming home for it. He has a quiver of
          'em.”
        </p>
        <p>
        ...
        <p>
          ...
          to grow a little genial, he became still less and less a recluse; as
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 29. Enter Ahab; to Him, Stubb.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          it to its place for fear of disturbing their slumbering shipmates;
          when this sort of steady quietude would begin to prevail, habitually,
          the silent steersman would watch the cabin-scuttle; and ere long the
          old man would emerge, gripping at the iron banister, to help his
          crippled way. Some considering touch of humanity was in him; for at
          times like these, he usually abstained from patrolling the
          ...
          common regardings; and as with heavy, lumber-like pace he was
          measuring the ship from taffrail to mainmast, Stubb, the old second
          mate, came up from below, with a certain unassured, deprecating
          humorousness, hinted that if Captain Ahab was pleased to walk the
          planks, then, no one could say nay; but there might be some way of
          muffling the noise; hinting something indistinctly and hesitatingly
          about a globe of tow, and the insertion into it, of the ivory heel.
        ...
        <p>
          ...
          where such as ye sleep between shrouds, to use ye to the filling one
        ...
        <p>
          ...
          as there must be something on a deck when it cracks. He aint in his
          bed now, either, more than three hours out of the twenty-four; and he
          don’t sleep then. Didn’t that Dough-Boy, the steward, tell me that of
          a morning he always finds the old man’s hammock clothes all rumpled
          ...
          baked brick had been on it? A hot old man! I guess he’s got what some
          ...
          the Lord keep me from catching it. He’s full of riddles; I wonder what
          he goes into the after hold for, every night, as Dough-Boy tells me he
          suspects; what’s that for, I should like to know? Who’s made
          appointments with him in the hold? Ain’t that queer, now? But there’s
          no telling, it’s the old game—Here goes for a snooze. Damn me, it’s
          ...
          babies do, and that’s a sort of queer, too. Damn me, but all things
          are queer, come to think of 'em. But that’s against my principles.
          Think not, is my eleventh commandment; and sleep when you can, is my
          twelfth—So here goes again. But how’s that? didn’t he call me a dog?
          ...
          the devil’s the matter with me? I don’t stand right on my legs. Coming
          afoul of that old man has a sort of turned me wrong side out. By the
          Lord, I must have been dreaming, though—How? how? how?—but the only
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          vapours among mild white hairs, not among torn iron-grey locks like
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          insult, that kick from Ahab. ‘Why,’ thinks I, ‘what’s the row? It’s
          not a real leg, only a false leg.’ And there’s a mighty difference
          between a living thump and a dead thump. That’s what makes a blow from
          the hand, Flask, fifty times more savage to bear than a blow from a
          cane. The living member—that makes the living insult, my little man.
          And thinks I to myself all the while, mind, while I was stubbing my
          silly toes against that cursed pyramid—so confoundedly contradictory
          was it all, all the while, I say, I was thinking to myself, ‘what’s
          his leg now, but a cane—a whalebone cane. Yes,’ thinks I, ‘it was only
          a playful cudgelling—in fact, only a whaleboning that he gave me—not a
          ...
          Slid! man, but I was frightened. Such a phiz! But, somehow, next
          moment I was over the fright. ‘What am I about?’ says I at last. ‘And
          what business is that of yours, I should like to know, Mr. Humpback?
          Do YOU want a kick?’ By the lord, Flask, I had no sooner said that,
          than he turned round his stern to me, bent over, and dragging up a lot
          of seaweed he had for a clout—what do you think, I saw?—why thunder
          ...
          fellow.’ ‘Wise Stubb,’ said he, ‘wise Stubb;’ and kept muttering it
          all the time, a sort of eating of his own gums like a chimney hag.
          Seeing he wasn’t going to stop saying over his 'wise Stubb, wise
          Stubb,’ I thought I might as well fall to kicking the pyramid again.
          But I had only just lifted my foot for it, when he roared out, ‘Stop
          that kicking!’ ‘Halloa,’ says I, ‘what’s the matter now, old fellow?’
          ‘Look ye here,’ says he; ‘let’s argue the insult. Captain Ahab kicked
          ye, didn’t he?’ ‘Yes, he did,’ says I—‘right HERE it was.’ ‘Very
          good,’ says he—‘he used his ivory leg, didn’t he?’ ‘Yes, he did,’ says
          I. ‘Well then,’ says he, ‘wise Stubb, what have you to complain of?
          Didn’t he kick with right good will? it wasn’t a common pitch pine leg
          he kicked with, was it? No, you were kicked by a great man, and with a
          ...
          glory to be slapped by a queen, and made garter-knights of; but, be
          YOUR boast, Stubb, that ye were kicked by old Ahab, and made a wise
          ...
          seemed somehow, in some queer fashion, to swim off into the air. I
          snored; rolled over; and there I was in my hammock! Now, what do you
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          classNameification of the constituents of a chaos, nothing less is
        ...
        <p>
          ...
          comprehensive classNameification, if only an easy outline one for the
        ...
        <p>
          ...
          Philologically considered, it is absurd. Some centuries ago, when the
          Sperm whale was almost wholly unknown in his own proper individuality,
          and when his oil was only accidentally obtained from the stranded
          fish; in those days spermaceti, it would seem, was popularly supposed
          to be derived from a creature identical with the one then known in
          England as the Greenland or Right Whale. It was the idea also, that
        ...
        <p>
          ...
          commerce. Among the fishermen, he is indiscriminately designated by
          ...
          Baliene Ordinaire of the French whalemen; the Growlands Walfish of the
          Swedes. It is the whale which for more than two centuries past has
          been hunted by the Dutch and English in the Arctic seas; it is the
        ...
        <p>
          ...
          Ahaz-dial the shadow often goes back. The Fin-Back is not gregarious.
          He seems a whale-hater, as some men are man-haters. Very shy; always
          going solitary; unexpectedly rising to the surface in the remotest and
          most sullen waters; his straight and single lofty jet rising like a
          tall misanthropic spear upon a barren plain; gifted with such wondrous
          ...
          is, whales with baleen. Of these so called Whalebone whales, there
        ...
        <p>
          ...
          in vain to attempt a clear classNameification of the Leviathan,
        ...
        <p>
          ...
          right classNameification. Nay; what thing, for example, is there in
          the Greenland whale’s anatomy more striking than his baleen? Yet we
          have seen that by his baleen it is impossible correctly to
          classNameify the Greenland whale. And if you descend into the bowels
          of the various leviathans, why there you will not find distinctions a
          ...
          that way. And this is the Bibliographical system here adopted; and it
          is the only one that can possibly succeed, for it alone is
        ...
        <p>
          ...
          popularly classNameed among whales. But possessing all the grand
        ...
        <p>
          ...
          hooked fin in swimming, which looks something like a Roman nose. When
          not more profitably employed, the sperm whale hunters sometimes
        ...
        <p>
          ...
          from the jaw in a line a little depressed from the horizontal. But it
          is only found on the sinister side, which has an ill effect, giving
          ...
          Narwhale—however that may be—it would certainly be very convenient to
          him for a folder in reading pamphlets. The Narwhale I have heard
          ...
          every kingdom of animated nature. From certain cloistered old authors
          I have gathered that this same sea-unicorn’s horn was in ancient days
          regarded as the great antidote against poison, and as such,
          preparations of it brought immense prices. It was also distilled to a
          volatile salts for fainting ladies, the same way that the horns of the
          male deer are manufactured into hartshorn. Originally it was in itself
          accounted an object of great curiosity. Black Letter tells me that Sir
          ...
          present to her highness another horn, pertaining to a land beast of
          the unicorn nature.
        </p>
        <p>
        ...
        <p>
          ...
          flogging him; as some schoolmasters get along in the world by a
        ...
        <p>
          ...
          among jewellers and watchmakers. Sailors put it on their hones.
          Porpoise meat is good eating, you know. It may never have occurred to
          you that a porpoise spouts. Indeed, his spout is so small that it is
          not very readily discernible. But the next time you have a chance,
          watch him; and you will then see the great Sperm whale himself in
          miniature.
        </p>
        <p>
          BOOK III. (DUODECIMO), CHAPTER II. (ALGERINE PORPOISE).—A pirate. Very
          savage. He is only found, I think, in the Pacific. He is somewhat
        ...
        <p>
          ...
          Whale; the Iceberg Whale; the Quog Whale; the Blue Whale; etc. From
          Icelandic, Dutch, and old English authorities, there might be quoted
          other lists of uncertain whales, blessed with all manner of uncouth
          names. But I omit them as altogether obsolete; and can hardly help
          suspecting them for mere sounds, full of Leviathanism, but signifying
          nothing.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 33. The Specksnyder.</h1>
        </header>
        <p>
          ...
          arising from the existence of the harpooneer className of officers, a
          className unknown of course in any other marine than the whale-fleet.
        </p>
        <p>
        ...
        <p>
          ...
          the world’s hustings; and leaves the highest honours that this air can
          ...
          Nicholas the Czar, the ringed crown of geographical empire encircles
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 34. The Cabin-Table.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          King Ahab’s presence, in the character of Abjectus, or the Slave.
        </p>
        <p>
        ...
        <p>
          ...
          What a relief it was to choking Stubb, when a rat made a sudden racket
          in the hold below. And poor little Flask, he was the youngest son, and
          ...
          larceny in the first degree. Had he helped himself at that table,
        ...
        <p>
          ...
          For what he ate did not so much relieve his hunger, as keep it
        ...
        <p>
          ...
          see whether any marks of teeth lurked in his own lean arms. And when
          he would hear Tashtego singing out for him to produce himself, that
          his bones might be picked, the simple-witted steward all but shattered
          the crockery hanging round him in the pantry, by his sudden fits of
          the palsy. Nor did the whetstone which the harpooneers carried in
          their pockets, for their lances and other weapons; and with which
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 35. The Mast-Head.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          even—then, her mast-heads are kept manned to the last; and not till
        ...
        <p>
          ...
          the peculiar stair-like formation of all four sides of those edifices;
          ...
          stars; even as the look-outs of a modern ship sing out for a sail, or
          a whale just bearing in sight. In Saint Stylites, the famous Christian
          hermit of old times, who built him a lofty stone pillar in the desert
          and spent the whole latter portion of his life on its summit, hoisting
          his food from the ground with a tackle; in him we have a remarkable
          instance of a dauntless stander-of-mast-heads; who was not to be
          driven from his place by fogs or frosts, rain, hail, or sleet; but
          valiantly facing everything out to the last, literally died at his
          post. Of modern standers-of-mast-heads we have but a lifeless set;
          mere stone, iron, and bronze men; who, though well capable of facing
          out a stiff gale, are still entirely incompetent to the business of
          singing out upon discovering any strange sight. There is Napoleon;
          ...
          the decks below; whether Louis Philippe, Louis Blanc, or Louis the
          Devil. Great Washington, too, stands high aloft on his towering
          ...
          Admiral Nelson, also, on a capstan of gun-metal, stands his mast-head
          in Trafalgar Square; and ever when most obscured by that London smoke,
        ...
        <p>
          ...
          every two hours. In the serene weather of the tropics it is
          ...
          monsters of the sea, even as ships once sailed between the boots of
          the famous Colossus at old Rhodes. There you stand, lost in the
          infinite series of the sea, with nothing ruffled but the waves. The
          tranced ship indolently rolls; the drowsy trade winds blow; everything
          resolves you into languor. For the most part, in this tropic whaling
          life, a sublime uneventfulness invests you; you hear no news; read no
          gazettes; extras with startling accounts of commonplaces never delude
          ...
          thought of what you shall have for dinner—for all your meals for three
          years and more are snugly stowed in casks, and your bill of fare is
          immutable.
        </p>
        <p>
        ...
        <p>
          ...
          down upon them is a very different thing. Now, it was plainly a labor
          of love for Captain Sleet to describe, as he does, all the little
          detailed conveniences of his crow’s-nest; but though he so enlarges
          upon many of these, and though he treats us to a very scientific
          account of his experiments in this crow’s-nest, with a small compass
          he kept there for the purpose of counteracting the errors resulting
          from what is called the “local attraction" of all binnacle magnets; an
          error ascribable to the horizontal vicinity of the iron in the ship’s
          ...
          admire and even love the brave, the honest, and learned Captain; yet I
          take it very ill of him that he should so utterly ignore that
          case-bottle, seeing what a faithful friend and comforter it must have
          been, while with mittened fingers and hooded head he was studying the
          mathematics aloft there in that bird’s nest within three or four
          perches of the pole.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 36. The Quarter-Deck.</h1>
        </header>
        <p className="direction-rw">(ENTER AHAB: THEN, ALL)</p>
        <p>
        ...
        <p>
          ...
          holes punctured in his starboard fluke—look ye, whosoever of ye raises
          me that same white whale, he shall have this gold ounce, my boys!”
        </p>
        <p>
        ...
        <p>
          ...
          If man will strike, strike through the mask! How can the prisoner
        ...
        <p>
          ...
          this way it comes. Hand it me—here’s a hollow! Men, ye seem the years;
        ...
        <p>
          ...
          men, you will yet see that—Ha! boy, come back? bad pennies come not
        ...
        <p>
          ...
          three most honourable gentlemen and noblemen, my valiant harpooneers.
          Disdain the task? What, when the great Pope washes the feet of
          beggars, using his tiara for ewer? Oh, my sweet cardinals! your own
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 37. Sunset.</h1>
        </header>
        <p className="direction-rw">
        ...
        <p>
          ...
          it bright with many a gem; I the wearer, see not its far flashings;
          but darkly feel that I wear that, that dazzlingly confounds. ‘Tis
          iron—that I know—not gold. ‘Tis split, too—that I feel; the jagged
        ...
        <p>
          ...
          your own size; don’t pommel ME! No, ye’ve knocked me down, and I am up
          again; but YE have run and hidden. Come forth from behind your cotton
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          have no knife to cut. Horrible old man! Who’s over him, he cries;—aye,
          he would be a democrat to all above; look, how he lords it over all
          below! Oh! I plainly see my miserable office,—to obey, rebelling; and
          worse yet, to hate with touch of pity! For in his eyes I read some
        ...
        <p>
          ...
          now that I do feel the latent horror in thee! but 'tis not me! that
          horror’s out of me! and with the soft feeling of the human in me, yet
          will I try to fight ye, ye grim, phantom futures! Stand by me, hold
          me, bind me, O ye blessed influences!
        </p>
      </section>
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 39. First Night Watch.</h1>
          <p className="title-sub-rw">Fore-Top.</p>
        </header>
        <p className="direction-rw">(STUBB SOLUS, AND MENDING A BRACE.)</p>
        <p>
          ...
          eye Starbuck then looked something as I the other evening felt. Be
          sure the old Mogul has fixed him, too. I twigged it, knew it; had had
          the gift, might readily have prophesied it—for when I clapped my eye
          upon his skull I saw it. Well, Stubb, WISE Stubb—that’s my title—well,
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 40. Midnight, Forecastle.</h1>
        </header>
        ...
        <p>
          ...
          So, so, (THRUSTS HIS HEAD DOWN THE SCUTTLE,) Star-bo-l-e-e-n-s,
        ...
        <p>
          ...
          hail ’em through it. Tell ’em to avast dreaming of their lasses. Tell
        ...
        <p>
          ...
          what they are dancing over. I’ll dance over your grave, I will—that’s
        ...
        <p>
          ...
          sky-born, high-tide Ganges turned to wind! Thou showest thy black
          brow, Seeva!
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          So that here, in the real living experience of living men, the
        ...
        <p>
          ...
          to turn round suddenly, and, bearing down upon them, either stave
        ...
        <p>
          ...
          ancient Ophites of the east reverenced in their statue devil;—Ahab did
          not fall down and worship it like them; but deliriously transferring
          ...
          life and thought; all evil, to crazy Ahab, were visibly personified,
          and made practically assailable in Moby Dick. He piled upon the
          whale’s white hump the sum of all the general rage and hate felt by
          his whole race from Adam down; and then, as if his chest had been a
        ...
        <p>
          ...
          Cluny where we here stand—however grand and wonderful, now quit
          it;—and take your way, ye nobler, sadder souls, to those vast Roman
          halls of Thermes; where far beneath the fantastic towers of man’s
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 42. The Whiteness of The Whale.</h1>
        </header>
        <p>
        ...
        <p>
          *I remember the first albatross I ever saw. It was during a prolonged
          ...
          uttered cries, as some king’s ghost in supernatural distress. Through
          its inexpressible, strange eyes, methought I peeped to secrets which
          took hold of God. As Abraham before the angels, I bowed myself; the
          white thing was so white, its wings so wide, and in those for ever
          exiled waters, I had lost the miserable warping memories of traditions
          ...
          that this glorious thing is utterly unknown to men ashore! never! But
          ...
          I saw that bird upon our deck. For neither had I then read the Rhyme,
          nor knew the bird to be an albatross. Yet, in saying this, I do but
        ...
        <p>
          ...
          sunniest day, if you but shake a fresh buffalo robe behind him, so
          that he cannot even see it, but only smells its wild animal
        ...
        <p>
          ...
          infidel gazes himself blind at the monumental white shroud that wraps
          all the prospect around him. And of all these things the Albino whale
          was the symbol. Wonder ye then at the fiery hunt?
        </p>
      </section>
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 43. Hark!</h1>
        </header>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          seemed only his casual stopping-places and ocean-inns, so to speak,
          not his places of prolonged abode. And where Ahab’s chances of
          ...
          Moby Dick had been periodically descried, lingering in those waters
          for awhile, as the sun, in its annual round, loiters for a predicted
          interval in any one sign of the Zodiac. There it was, too, that most
          of the deadly encounters with the white whale had taken place; there
          the waves were storied with his deeds; there also was that tragic spot
          ...
          vigilance with which Ahab threw his brooding soul into this
          unfaltering hunt, he would not permit himself to rest all his hopes
          upon the one crowning fact above mentioned, however flattering it
          might be to those hopes; nor in the sleeplessness of his vow could he
          so tranquillize his unquiet heart as to postpone all intervening
          quest.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 45. The Affidavit.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          whose lofty jet they say at times assumed the semblance of a
          ...
          the students of Cetacean History as Marius or Sylla to the classNameic
          scholar.
        </p>
        <p>
        ...
        <p>
          ...
          commanding an American sloop-of-war of the first className, happened
          to be dining with a party of whaling captains, on board a Nantucket
          ...
          I am not superstitious, but I consider the Commodore’s interview with
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          be that a long interval would elapse ere the White Whale was seen.
          ...
          ordinary, prudential, circumstantial influences were brought to bear
          upon him. Not only that, but the subtle insanity of Ahab respecting
          Moby Dick was noways more significantly manifested than in his
          ...
          voyage must be kept withdrawn into the obscure background (for few
          men’s courage is proof against protracted meditation unrelieved by
          action); that when they stood their long night watches, his officers
          ...
          less capricious and unreliable—they live in the varying outer weather,
          and they inhale its fickleness—and when retained for any object remote
          and blank in the pursuit, however promissory of life and passion in
          the end, it is above all things requisite that temporary interests and
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 47. The Mat-Maker.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          the woof slantingly, or crookedly, or strongly, or weakly, as the case
          might be; and by this difference in the concluding blow producing a
          ...
          chance, free will, and necessity—nowise incompatible—all
        ...
        <p>“Where-away?”</p>
        <p>“On the lee-beam, about two miles off! a school of them!”</p>
        <p>Instantly all was commotion.</p>
        <p>
        ...
        <p>“Quick, steward!” cried Ahab. “Time! time!”</p>
        <p>
        ...
        <p>
          ...
          off in the opposite quarter—this deceitfulness of his could not now be
          in action; for there was no reason to suppose that the fish seen by
      ...
      <section className="body-rw Chapter-rw">
        <header>
          <h1>Chapter 48. The First Lowering.</h1>
        </header>
        <p>
        ...
        <p>
          ...
          cheers, men—all hearts alive! Easy, easy; don’t be in a hurry—don’t be
          in a hurry. Why don’t you snap your oars, you rascals? Bite something,
          ...
          something! pull, and start your eyes out! Here!” whipping out the
          sharp knife from his girdle; “every mother’s son of ye draw his knife,
          and pull with the blade between his teeth. That’s it—that’s it. Now ye
          do something; that looks like it, my steel-bits. Start her—start her,
        ...
        <p>
          ...
          whales had irregularly settled bodily down into the blue, thus giving
          no distantly discernible token of the movement, though from his closer
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          unseen and unaccountable old joker. That odd sort of wayward mood I am
          ...
          seems but a part of the general joke. There is nothing like the perils
          of whaling to breed this free and easy sort of genial, desperado
          philosophy; and with it I now regarded this whole voyage of the
        ...
        <p>
          ...
          fellow who at that very moment is in his impetuousness upon the point
          of scuttling the craft with his own frantic stampings; considering
          that the particular disaster to our own particular boat was chiefly to
          be imputed to Starbuck’s driving on to his whale almost in the teeth
          ...
          White Whale: taking all things together, I say, I thought I might as
          well go below and make a rough draft of my will. “Queequeg,” said I,
        ...
        <p>
          ...
          I looked round me tranquilly and contentedly, like a quiet ghost with
          a clean conscience sitting inside the bars of a snug family vault.
        </p>
        <p>
      ...
      <section className="body-rw Chapter-rw">
        ...
        <p>
          ...
          That would disable him; but he has one knee, and good part of the
          other left, you know.”
        </p>
        ...
        <p>
          ...
          that matter. Until Cabaco’s published discovery, the sailors had
